<?php
if (!function_exists('ovum_bc_setup')) :
	function ovum_bc_setup()
	{
		/**
...
add_action('after_setup_theme', 'ovum_bc_setup');
...
// Custom logo
function ovum_bc_custom_logo_setup()
{
	$defaults = array(
		'height'               => 100,
		'width'                => 400,
...
add_action('after_setup_theme', 'ovum_bc_custom_logo_setup');
