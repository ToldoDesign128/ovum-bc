    ...
    <div class="container footer">
        ...
        <div class="footer__col__2">
            <div class="footer__col__2__subcol">
                ...
                <!-- P.Iva title -->
                <?php
                $titolo_piva = get_field('titolo_piva_footer', 'option');
                if (!empty($titolo_piva)) : ?>
                    <p class="footer__col__2__subcol__piva-title"><?php echo esc_html($titolo_piva); ?></p>
                <?php endif; ?>
                <!-- P.Iva -->
                <?php
                $piva = get_field('piva_footer', 'option');
                if (!empty($piva)) : ?>
                    <p class="footer__col__2__subcol__piva__text"><?php echo esc_html($piva); ?></p>
                <?php endif; ?>
            </div>
            <div class="footer__col__2__subcol">
                <!-- Social title -->
    ...
    <div class="footer-credits">
        <div class="container footer-credits-box">
            <div class="credits">
                <p class="">
                    Powered by
                    <a href="https://www.exvoid.it/" target="_blank" class="">ExVoid</a>
                    ...
                    <a href="https://ovumdesign.it/" target="_blank" class="">Ovum</a>
                </p>
